...
[L_QWERTY] = LAYOUT_ansi_84(
     ...
     KC_LCTL,  KC_LOPTN, KC_LCMMD,                               KC_SPC,                       KC_RCMMD, MO(L_LIGHTS),       KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT
// w KC_LCTL,  KC_LGUI,  KC_LALT,                                KC_SPC,                       KC_RALT,  MO(L_LIGHTS),       KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT
),
...
[L_COLEMAK] = LAYOUT_ansi_84(
     ...
     LT(L_CAPS,KC_BSPC), KC_A,     KC_R,     KC_S,     KC_T,     KC_D,     KC_H,     KC_N,     KC_E,     KC_I,     KC_O,     KC_QUOT,            KC_ENT,             KC_HOME,
     SC_LSPO,            KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_K,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,            SC_RCPC,            KC_UP,    KC_END,
     KC_LCTL,  KC_LOPTN, KC_LCMMD,                               KC_SPC,                                 KC_RCMMD, MO(L_TBD),KC_RCTL,            KC_LEFT,  KC_DOWN,  KC_RGHT
),
...
[L_CAPS] = LAYOUT_ansi_84(
     ...
     _______,            G(KC_Z),  G(KC_X),  G(KC_C),  G(KC_V),  G(KC_B),  G(KC_K),  G(KC_M),  _______,  _______,  _______,            SC_RCPC,            KC_UP,    _______,
     _______,  _______,  _______,                                G(KC_SPC),                              _______,  _______,  _______,            _______,  _______,  _______
),

[L_TBD] = LAYOUT_ansi_84(
