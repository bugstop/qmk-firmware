...
[L_QWERTY] = LAYOUT_ansi_84(
     ...
     KC_LCTL,  KC_LOPTN, KC_LCMMD,                               KC_SPC,                       KC_INS,   KC_HOME,  KC_END,             KC_LEFT,  KC_DOWN,  KC_RGHT
// w KC_LCTL,  KC_LGUI,  KC_LALT,                                KC_SPC,                       KC_INS,   KC_HOME,  KC_END,             KC_LEFT,  KC_DOWN,  KC_RGHT
),
...
[L_COLEMAK] = LAYOUT_ansi_84(
     KC_ESC,             KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,  MO(L_BOTH),QK_LOCK,  KC_LANG_CN,
     KC_GRV,             KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,            KC_DEL,
     KC_TAB,             KC_Q,     KC_W,     KC_F,     KC_P,     KC_G,     KC_J,     KC_L,     KC_U,     KC_Y,     KC_SCLN,  KC_LBRC,  KC_RBRC,  KC_BSLS,            KC_PGUP,
     LT(L_CAPS,KC_BSPC), KC_A,     KC_R,     KC_S,     KC_T,     KC_D,     KC_H,     KC_N,     KC_E,     KC_I,     KC_O,     KC_QUOT,            KC_ENT,             KC_PGDN,
     KC_LSFT_PO,         KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_K,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,            KC_RCTL_PC,         KC_UP,    KC_SECURE,
     KC_LCTL,  KC_LOPTN, KC_LCMMD,                               KC_SPC,                                 KC_INS,   KC_HOME,  KC_END,             KC_LEFT,  KC_DOWN,  KC_RGHT
),
...
[L_CAPS] = LAYOUT_ansi_84(
     ...
     _______,            G(KC_Z),  G(KC_X),  G(KC_C),  G(KC_V),  G(KC_B),  G(KC_K),  G(KC_M),  _______,  _______,  _______,            KC_RCTL_PC,         _______,  _______,
...
[L_BOTH] = LAYOUT_ansi_84(
     _______,            KC_BRID,  KC_BRIU,  KC_TASK,  KC_FILE,  RGB_VAD,  RGB_VAI,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU,  _______,  _______,  _______,
     _______,            _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            BT_HST1,
     RGB_TOG,            RGB_MOD,  RGB_VAI,  RGB_HUI,  RGB_SAI,  RGB_SPI,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            BT_HST2,
     KC_TRNS,            RGB_RMOD, RGB_VAD,  RGB_HUD,  RGB_SAD,  RGB_SPD,  _______,  _______,  _______,  _______,  _______,  _______,            _______,            BT_HST3,
     _______,            _______,  _______,  _______,  _______,  BAT_LVL,  NK_TOGG,  _______,  _______,  _______,  _______,            KC_TRNS,            _______,  _______,
     _______,  _______,  _______,                                _______,                                _______,  _______,  _______,            _______,  _______,  _______
),
